...
public class Set_watchdog_thresholds_arrayTest {
	...
	public void test_run_2() {
		...
		double temp_watchdog_thresholds_array_21 = 200 * temp_watchdog_scale_factor_1;
		...
		assertEquals(temp_watchdog_thresholds_array_21,  UUT_TCPclient.get_watchdog_threshold(Watchdog_Thresholds.HIGHEST, UUT_TCPclient.watchdog_thresholds_array), 0.001);
		...
		double temp_watchdog_thresholds_array_22 = 200 * temp_watchdog_scale_factor_2;
		...
		assertEquals(temp_watchdog_thresholds_array_22,  UUT_TCPclient.get_watchdog_threshold(Watchdog_Thresholds.HIGHEST, UUT_TCPclient.watchdog_thresholds_array), 0.001);	
	}
