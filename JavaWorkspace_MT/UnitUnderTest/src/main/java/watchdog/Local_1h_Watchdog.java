...
public class Local_1h_Watchdog implements Runnable { 
     ...
     */ 
    protected Local_1h_Watchdog(double global_watchdogs_scale_factor) {            
     ...
     */ 
    public static synchronized Local_1h_Watchdog getInstance() { 
        if (m_instance == null) { 
            m_instance = new Local_1h_Watchdog(TCPclient.getWatchdogs_scale_factor()); 
        } 
        return m_instance; 
    } 
